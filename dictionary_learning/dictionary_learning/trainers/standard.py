...
class StandardTrainer(SAETrainer):
    ...
    def resample_neurons(self, deads, activations):
        with t.no_grad():
            ...
            alive_norm = alive_norm.to(self.ae.encoder.weight.dtype)
    ...
    def resample_neurons_advanced(self, deads, activations):
        pass
        ...
        if not logging:
            ...
            return namedtuple('LossLog', ['x', 'x_hat', 'f', 'losses'])(
                x, x_hat, f,
                {
                    ...
                    'l1_loss_with_coeff' : (self.l1_penalty * sparsity_scale * l1_loss).item(),
                    'loss' : loss.item(),
                    'l1_coeff' : sparsity_scale*self.l1_penalty,
