...
def main():
    ...
    folder_path = os.path.join(config.SAE_CKPTS,"sweep",model_name,dataset_name+"_standard3")
    ...
    for i,file in enumerate(os.listdir(folder_path)):
        ...
        alive_features_count = (feature_buffer.features != 0).sum(dim=0)
        print("Rate of dead features :",(alive_features_count == 0).sum()/dict_size)
